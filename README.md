## 平台简介
引用说明:
    本平台是我在git上发现的一款权限管理架构,项目名称叫若依,感谢作者.

个人准备在此基础上进行改造,开发,

> 如需前后端分离版本，请移步 [RuoYi-Vue](https://gitee.com/y_project/RuoYi-Vue))(源项目地址)

> 如需单应用，请移步 [RuoYi-fast](https://gitee.com/y_project/RuoYi-fast) (源项目地址) `(保持同步更新)`，如需其他版本，请移步 [项目扩展](http://doc.ruoyi.vip/ruoyi/document/xmkz.html)  `(不定时更新)`
